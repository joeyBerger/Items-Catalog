...
MusicalInstrument1 = MusicalInstrument(
    user_id=1,
    name="Guitar",
    availableColors="Red,White,Black,Sunburst,Blue,Green,Natural")
...
model1 = Model(
    user_id=1,
    name="Gibson 2016 Les Paul Studio HP Electric Guitar",
    description="The 2016 Les Paul Studio HP is the supercharged counterpart of the traditional Les Paul Studio.",
    price="$1,659.00",
    color="Sunburst",
    musicalInstrument=MusicalInstrument1)
...
MusicalInstrument2 = MusicalInstrument(
    user_id=2,
    name="Bass",
    availableColors="Red,White,Black,Blue,Green")
...
model1 = Model(
    ...
    price="$799.99",
    color="White",
    musicalInstrument=MusicalInstrument2)
...
model3 = Model(
    user_id=2,
    name="Rogue VB100 Violin Bass Guitar Vintage",
    description="A classic design with updated appointments to make it even sweeter than the original!The Rogue VB-100 violin bass guitar features a flamed maple arched top and back with the European-style hollowbody that makes it lightweight and capable of deep, resonant bass tones. The violin bass's traditional 31 inch scale offers immediate familiarity in your hands. A custom trapeze tailpiece, pearloid pickguard, and body binding on front and back are added touches. Don't be fooled by the tiny price; this Rogue a serious violin bass nicely made with all the playability and tone of the original at a fraction of the cost.",
    price="$169.99",
    color="Blue",
    musicalInstrument=MusicalInstrument2)
...
MusicalInstrument3 = MusicalInstrument(
    user_id=1,
    name="Drums",
    availableColors="Blue Sparkle,Red Sparkle,Black")
...
model2 = Model(
    user_id=1,
    name="Allora Paris Series Professional Alto Saxophone",
    description="Precise intonation, quick response, and a big sound are just a few of the great features you will find in the Allora Paris Series Saxophones. The attention to detail, from the hand-engraving to the key adjustment is usually reserved for instruments that are much more expensive. You truly cannot go wrong with this alto saxophone. Featuring ribbed construction, a red brass body, Pisoni Pro pads, hand engraving, and a choice of finishes, the Paris Series Alto Saxophone is as fun to play as it is good looking. Every Allora instrument undergoes a shop key adjustment usually reserved for instruments that are much more expensive. You truly cannot go wrong with this fine alto.",
    price="$1,499.99",
    color="Gold",
    musicalInstrument=MusicalInstrument4)
...
model2 = Model(
    ...
    price="$269.99",
    color="White",
    musicalInstrument=MusicalInstrument5)
...
model3 = Model(
    user_id=1,
    name="Gemeinhardt 3SHB Series Intermediate Flute",
    description="The model 3SHB offers the resonance and tone quality of a solid silver headjoint combined with the French key mechanism (open-hole keys) often requested on an intermediate student instrument. The 3SHB offers specifications many teachers recommend for a step-up student flute.",
    price="$999.00",
    color="Gold",
    musicalInstrument=MusicalInstrument5)
...
MusicalInstrument6 = MusicalInstrument(
    user_id=1,
    name="Trombone",
    availableColors="Brass,White")
